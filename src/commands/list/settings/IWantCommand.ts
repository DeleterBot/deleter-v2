...
import IWantCommandConfig from '@src/commands/list/settings/resources/configs/IWantCommandConfig'
...
export default class IWantCommand extends BaseCommand {
  constructor() {
    super('@deleter.commands.list.settings.IWantCommand', new IWantCommandConfig())
  }
